...
function makeVillageList({ villageList, newVillage, landArea }) {
  ...
  // console.log({ ...newVillage }); // 뉴빌리지의 속성만 {id: 'E', x: 400, y: 298, width: 221, height: 154}
  ...
  if (
    ...
    const newVillageElement = createVillage({
      ...newVillage, // {id: 'E', x: 400, y: 298, width: 221, height: 154}
      x: newVillage.x + landArea.offsetLeft,
      y: newVillage.y + landArea.offsetTop,
    });

    villageList.push(newVillage); // {id: 'E', x: 400, y: 298, width: 221, height: 154}
    landArea.appendChild(newVillageElement); // <div></div>
